...
{ blankSlate: true,
  cursorTag: 'AAEpZb4WyUJdxmzR9O0dH8t6-RKxFOeLjI9iCznLukxbYzYPS-GbtEKF_EkhOoQzzfg16f3lzeyevnDa560X6hD0OXJFZwdG2Bbj9Ar3qefpMA',
  shouldPullAgain: false,
  shouldBackOff: true,
  changes: 
   [ { path: '/hello.txt', stat: [Object], wasRemoved: false },
     { path: '/img', stat: [Object], wasRemoved: false },
     { path: '/img/file feb 23, 8 11 50 pm.jpeg',
       stat: [Object],
       wasRemoved: false } ] }
	...
	*/
	...
	redis_client.get('db_cursor', function(err, reply) {
		...
		console.log('Doing a delta on dropbox changes: ' + db_cursor);


		dropbox_client.delta(db_cursor, function(err, changes){
			...
			if ( changes ) {
				...
				redis_client.set('db_cursor', changes.cursorTag);
